...
class GetAvailableLeaveTypeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'leave_type_id', 'icon', 'available_days', 'carryforward_days', 'total_leave_days']
...
class userLeaveRequestGetAllSerilaizer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        exclude = ['requested_date','description', 'attachment', 'approved_available_days', 'approved_carryforward_days',
                   'created_at', 'reject_reason', 'employee_id', 'created_by']
...
class LeaveRequestGetAllSerilaizer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LeaveRequest
        exclude = ['requested_date','description', 'attachment', 'approved_available_days', 'approved_carryforward_days',
                   'created_at', 'reject_reason', 'created_by']
    ...
    def get_multiple_approve(self, obj):
        ...
        if approvals and obj.status == "requested":
            ...
            is_approved = True if is_approved.filter(manager_id=employee).exists() else False
...
class LeaveAllocationRequestSerilaizer(serializers.ModelSerializer):
    class Meta:
        model = LeaveAllocationRequest
        exclude = ['requested_date', 'status', 'created_by', 'created_at', 'reject_reason']
