...
urlpatterns = [
    ...
    path('attendance/list/<str:type>',
         AttendanceView.as_view(), name='attendance-list'),
    path('attendance-validate/<int:pk>',
         ValidateAttendanceView.as_view(), name=''),

    path('attendance-request/', AttendanceRequestView.as_view(),
         name='attendance-request-view'),
    path('attendance-request/<int:pk>', AttendanceRequestView.as_view(),
         name='attendance-request-view'),
    path('attendance-request-approve/<int:pk>',
         AttendanceRequestApproveView.as_view(), name=''),
    path('attendance-request-cancel/<int:pk>',
         AttendanceRequestCancelView.as_view(), name=''),
    path('overtime-approve/<int:pk>', OvertimeApproveView.as_view(), name=''),

    path('attendance-hour-account/<int:pk>/',
         AttendanceOverTimeView.as_view(), name=''),
